  ...
  return (
    <div style={{ direction: "rtl", minHeight: "11vh", }}>
      ...
      {state.form == "bookspecs" ? <WindowFloat
        ...
        <g-b style={{
          backgroundColor:
            state.cart.includes(state.book.title) ? "#985D5D" : "#497C63"
        }}
          onClick={() => {
      ...
      <Window title=" black widows Hossein HosseinDoost"style={{ margin: 15 , width: "calc(100% - 20px)", backgroundColor:"#538C9B"}} >
        <f-cse style={{
          ...
          <f-c>
          <f-c>
            <img src="https://www.goldiran.ir/UserFiles/Icon%20Ok-28.png"
          ...
          <f-c>
          <f-c>
            <img src="https://www.goldiran.ir/UserFiles/Icon%20Ok-30.png"
      ...
      style={{ minHeight: 200, margin: 10 , width: "calc(100% - 20px)" , backgroundColor:"#00FFFF" }}>
